...
15.6 & \class{FishTankVolume} throwing exceptions & & & 20 \\ \hline
15.8 & \class{Date} class with nested try statements & & & 20 \\ \hline
\hline
Total &                                  &       &      & 40 \\ \hline
\hline
\end{tabular} \\ \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 15.6 \class{FishTankVolume} throwing exceptions} \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 15.8 \class{Date} class with nested try statements} \\
\noindent{\bf Completeness and correctness matrix} \\
Marker -- please ring appropriate mark and transfer to marks table below. \\
