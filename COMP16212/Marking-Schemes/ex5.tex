...
18.6 & Deleting a field, from anywhere to anywhere & & & 20 \\ \hline
18.7 & Encoding binary in text & & & 20 \\ \hline
\hline
Total &                                  &       &      & 40 \\ \hline
\hline
\end{tabular} \\ \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 18.6 Deleting a field, from anywhere to anywhere} \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 18.7 Encoding binary in text} \\
\noindent{\bf Completeness and correctness matrix} \\
Marker -- please ring appropriate mark and transfer to marks table below. \\
