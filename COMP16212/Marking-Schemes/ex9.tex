...
21.8 & Finding duplicate voters, using a \class{HashMap} & & & 20 \\ \hline
22.5 & Reversing lines & & & 20 \\ \hline
\hline
Total &                                  &       &      & 40 \\ \hline
\hline
\end{tabular} \\ \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 21.8 Finding duplicate voters, using a \class{HashMap}} \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 22.5 Reversing lines} \\
\noindent{\bf Completeness and correctness matrix} \\
Marker -- please ring appropriate mark and transfer to marks table below. \\
