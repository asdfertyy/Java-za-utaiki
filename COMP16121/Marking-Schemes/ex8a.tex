...
11.3 & \class{StudentsCalling} & & & 20 \\ \hline
12.2 & \class{StudentsCalling} with doc comments & & & 20 \\ \hline
\hline
Total &                                  &       &      & 40 \\ \hline
\hline
\end{tabular} \\ \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 11.3 \class{StudentsCalling}} \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 12.2 \class{StudentsCalling} with doc comments} \\
\noindent{\bf Completeness and correctness matrix} \\
Marker -- please ring appropriate mark and transfer to marks table below. \\
