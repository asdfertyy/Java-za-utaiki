...
\noindent{\Large \bf Exercise 9 -- Task totals} \\ \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 13.7 \class{StopClock} with split time} \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 13.8 \class{GCD} GUI for three numbers} \\
\noindent{\bf Completeness and correctness matrix} \\
Marker -- please ring appropriate mark and transfer to marks table below. \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 13.9 \class{StopClock} using a text field and disabled split button} \\
\noindent{\bf Completeness and correctness matrix} \\
Marker -- please ring appropriate mark and transfer to marks table below. \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 13.12 \class{ThreeWeights} GUI} \\
\noindent{\bf Completeness and correctness matrix} \\
Marker -- please ring appropriate mark and transfer to marks table below. \\
