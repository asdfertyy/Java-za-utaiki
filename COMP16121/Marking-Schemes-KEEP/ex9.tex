...
\parbox{\textwidth}{
\noindent{\Large \bf Task 13.7 StopClock with split time} \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 13.8 GCD GUI for three numbers} \\
\noindent{\bf Completeness and correctness matrix} \\
Marker -- please ring appropriate mark and transfer to marks table below. \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 13.9 StopClock using a text field and disabled split button} \\
\noindent{\bf Completeness and correctness matrix} \\
Marker -- please ring appropriate mark and transfer to marks table below. \\
...
\parbox{\textwidth}{
\noindent{\Large \bf Task 13.12 ThreeWeights GUI} \\
\noindent{\bf Completeness and correctness matrix} \\
Marker -- please ring appropriate mark and transfer to marks table below. \\
